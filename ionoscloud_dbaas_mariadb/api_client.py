...
from ionoscloud_dbaas_mariadb.api_response import ApiResponse, T as ApiResponseT
import ionoscloud_dbaas_mariadb.models
from ionoscloud_dbaas_mariadb import rest
from ionoscloud_dbaas_mariadb.exceptions import (
    ApiValueError,
    ApiException,
    ApiFailedRequest,
    ApiTimeout,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ionoscloud_dbaas_mariadb.models, klass)
