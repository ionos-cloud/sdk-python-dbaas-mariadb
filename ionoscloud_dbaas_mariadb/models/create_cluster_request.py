...
class CreateClusterRequest(BaseModel):
    ...
    """ # noqa: E501
    properties: Optional[CreateClusterProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": CreateClusterProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
